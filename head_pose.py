"""
head_pose.py — Stable head orientation estimation
Uses MediaPipe FaceMesh landmarks and 2D geometry for reliable live head direction.
This avoids unstable solvePnP values like -170 pitch on normal webcam input.
"""
...
def _raw_score(pitch, yaw, roll):
    ...
    # Penalise only when clearly away from centre
